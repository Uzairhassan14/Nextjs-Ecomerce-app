  ...
  return (
    <div className="flex  gap-5 flex-wrap">
      <div className="flex flex-nowrap gap-5">
        <div>
          <Image src={product} alt="productImages" height={120} width={120} />
        </div>
        <div>
          <Image src={product} alt="productImages" height={500} width={500} />
        </div>
      </div>

      <div className="flex-col justify-between ">
        <h3 className="font-semibold text-3xl flex-wrap md:w-56">
          Brushed Raglan Sweatshirt
        </h3>
        <h6 className="font-semibold text-xl mt-1 text-slate-500">Sweater</h6>

        <h6 className="font-semibold  mt-5 text-lg">Select Size</h6>
        ...
        <div className="flex justify-between mt-5">
          <h2 className="font-semibold  text-xl text-slate-900">Quantity: </h2>
        ...
        <div className="flex items-center  mt-5">
          <Button className="bg-slate-900 tracking-widest leading-5 bored-4  h-12   w-44 rounded-none shadow-none border-3 border-[#4e4e4e] flex-wrap">
            <ShoppingCart className="mr-5 h-6 w-6    " /> Add to Cart
          </Button>

          <p className="font-semibold text-3xl ml-2">$100</p>
        </div>
      </div>
    </div>
  );
