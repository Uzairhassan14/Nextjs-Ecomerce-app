  ...
  return (
    <div className="flex justify-between">
      <div className="header-left-side">
        ...
        <h1 className="md:text-6xl md:w-[60%]   text-4xl font-bold mt-5 mr-5">
          An Industrial Take on Streetwear
        </h1>
        <p className="pr-10 mt-5 md:w-[60%]">
        ...
        <div className="my-5">
          <Link href="/pages/all-product">
            <Button className="bg-slate-900 tracking-widest leading-5 border-2  h-16 w-44 rounded-none shadow-none border-[#686868] flex-wrap">
